...
cast = DataFrame.from_cnv('/home/riesna/MSc2018/ESIM_AntTest/Winter2017_M03_IceHandheld.cnv') #import .cnv file (create list for multiple CTD files)
...
plt.suptitle('Winter 2017', y=1.09,x=-0.8,fontsize=15)
